...
export function Delete(props: {
  ...
  return (
    <button className="flex flex-row gap-2 items-center justify-center font-medium text-softRed hover:text-paleRed fill-softRed hover:fill-paleRed" onClick={props.handleClick}>
